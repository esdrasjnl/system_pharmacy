...
extern void *mono_aot_module_ChartJs_Blazor_info;
extern void *mono_aot_module_ClosedXML_info;
extern void *mono_aot_module_ClosedXML_Parser_info;
extern void *mono_aot_module_CurrieTechnologies_Razor_SweetAlert2_info;
extern void *mono_aot_module_DocumentFormat_OpenXml_info;
extern void *mono_aot_module_DocumentFormat_OpenXml_Framework_info;
extern void *mono_aot_module_ExcelNumberFormat_info;
...
extern void *mono_aot_module_RBush_info;
extern void *mono_aot_module_SixLabors_Fonts_info;
extern void *mono_aot_module_System_IO_Packaging_info;
extern void *mono_aot_module_SistemaFarmacia_DTO_info;
extern void *mono_aot_module_SistemaFarmacia_WebAssembly_info;
...
void register_aot_modules (void)
{
	...
	mono_aot_register_module (mono_aot_module_ChartJs_Blazor_info);
	mono_aot_register_module (mono_aot_module_ClosedXML_info);
	mono_aot_register_module (mono_aot_module_ClosedXML_Parser_info);
	mono_aot_register_module (mono_aot_module_CurrieTechnologies_Razor_SweetAlert2_info);
	mono_aot_register_module (mono_aot_module_DocumentFormat_OpenXml_info);
	mono_aot_register_module (mono_aot_module_DocumentFormat_OpenXml_Framework_info);
	mono_aot_register_module (mono_aot_module_ExcelNumberFormat_info);
	...
	mono_aot_register_module (mono_aot_module_RBush_info);
	mono_aot_register_module (mono_aot_module_SixLabors_Fonts_info);
	mono_aot_register_module (mono_aot_module_System_IO_Packaging_info);
	mono_aot_register_module (mono_aot_module_SistemaFarmacia_DTO_info);
	mono_aot_register_module (mono_aot_module_SistemaFarmacia_WebAssembly_info);
